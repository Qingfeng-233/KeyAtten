...
def create_bundle(bundle_path: Path) -> None:
    ...
    members = [
        root / "benchmark" / "train_hidden_state_head.py",
        root / "benchmark" / "run_hidden_head_benchmark.py",
        root / "benchmark" / "keyword_bench",
...
def main() -> None:
    ...
    commands = [
        ...
        (
            ...
            f"python3 benchmark/train_hidden_state_head.py "
            f"--root-dir 测试沙箱 "
